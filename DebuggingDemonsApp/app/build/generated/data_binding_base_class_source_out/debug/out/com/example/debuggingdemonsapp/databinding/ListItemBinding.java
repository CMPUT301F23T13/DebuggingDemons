...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull ConstraintLayout rootView, @NonNull CheckBox itemCheckbox,
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((ConstraintLayout) rootView, itemCheckbox, itemName);
    }
