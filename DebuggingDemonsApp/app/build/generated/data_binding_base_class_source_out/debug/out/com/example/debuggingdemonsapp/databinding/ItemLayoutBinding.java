...
public final class ItemLayoutBinding implements ViewBinding {
  ...
  private ItemLayoutBinding(@NonNull LinearLayout rootView, @NonNull TextView textViewDate,
  ...
  public static ItemLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLayoutBinding((LinearLayout) rootView, textViewDate, textViewDescription);
    }
