...
public final class FragmentTagBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentTagBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentTagBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_tag, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentTagBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTagBinding((LinearLayout) rootView, addTagButton, tagList);
    }
